...
INSERT INTO members (id, passwords, email, member_since, payment_due) VALUES 
...
BEGIN
	INSERT INTO members (id, passwords, email) VALUES (p_id, p_passwords, p_email);
END $$
...
CREATE PROCEDURE update_member_passwords (IN p_id VARCHAR(255), IN p_passwords VARCHAR(255))
BEGIN
...
CALL update_member_passwords ('noah51', '18Oct1976');
